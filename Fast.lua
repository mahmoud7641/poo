...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1095638828,5488301592}
...
send(data.chat_id,data.id,"اهلا بك في صانع بوتات القرآن\nتم ادارته من قِبَلْ @VL_VD","html",true, false, false, true, reply_markup)
return false 
end
---making user
